...
def test_hardware_ci_item_creation(init_database):
    ...
    assert item.current_version.provider == ITEM_PROVIDER
    assert item.current_version.software_version == ITEM_SOFTWARE_VERSION
...
def test_hardware_ci_item_update(init_database):
    ...
    assert item.current_version.provider == ITEM_NEW_PROVIDER
    assert item.current_version.software_version == ITEM_NEW_SOFTWARE_VERSION